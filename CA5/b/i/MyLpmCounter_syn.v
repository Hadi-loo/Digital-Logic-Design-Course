...
//lpm_counter DEVICE_FAMILY="Cyclone IV GX" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=8 aclr clock cout data q sload
...
module MyLpmCounter (
	...
	MyLpmCounter_cntr	MyLpmCounter_cntr_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.sload (sload),
