...
//lpm_counter DEVICE_FAMILY="Cyclone IV GX" lpm_avalue=79 lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=8 aset clock cout data q sload
...
`endif
	...
	defparam
		counter_comb_bita_1.lut_mask = 16'h5A60,
	...
	defparam
		counter_comb_bita_2.lut_mask = 16'h5A60,
	...
	defparam
		counter_comb_bita_3.lut_mask = 16'h5A60,
	...
	defparam
		counter_comb_bita_6.lut_mask = 16'h5A60,
	...
	assign
		wire_counter_reg_bit_asdata = (a_val ^ ({8{(~ sclr)}} & (({8{sset}} & s_val) | ({8{(~ sset)}} & data)))),
...
module Counter8Bit (
	...
	Counter8Bit_cntr	Counter8Bit_cntr_component (
				.aset (aset),
				.clock (clock),
				.data (data),
				.sload (sload),
